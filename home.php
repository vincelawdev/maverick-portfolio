...
?>
            ...
            <div class="home-slides-projects flexslider"><?php mp_options::mp_display_projects('', mp_options::mp_get_page(), false, '', 'slides', 'home-slides-projects-item', 'home-slides-projects-item-wrapper', true, 15); ?></div>
