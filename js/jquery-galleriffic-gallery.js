jQuery(document).ready(function($)
{
	...
	$("#gallery_thumbnails ul.thumbs li, #gallery_thumbnails a.previous, #gallery_thumbnails a.next").opacityrollover(
	{
	...
	gallery = $("#gallery_thumbnails").galleriffic(
	{
		numThumbs:                 5,							
		preloadAhead:              10,
		maxPagesToShow:			   100,							
		...
		enableHistory:             true,
		imageContainerSel:         "#gallery_preview",
